<template>
    <div>
        <audio id="audio-long-break" :src="'./assets/audio/alert-long-break.mp3'"></audio>
        <audio id="audio-short-break" :src="'./assets/audio/alert-short-break.mp3'"></audio>
        <audio id="audio-work" :src="'./assets/audio/alert-work.mp3'"></audio>
    </div>
</template>
